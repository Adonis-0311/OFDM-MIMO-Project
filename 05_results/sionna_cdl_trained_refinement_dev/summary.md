...
- Mean channel NMSE gain vs grid: `3.54428` dB
- Mean physical delay RMSE: grid `461.138` ns -> trained `455.872` ns
- Mean projected-angle RMSE: grid `30.0077` deg -> trained `35.6084` deg
- Elapsed seconds: `1.98`
...
- `05_results\sionna_cdl_trained_refinement_dev\sionna_cdl_trained_refinement.csv`
- `05_results\sionna_cdl_trained_refinement_dev\sionna_cdl_trained_refinement_samples.csv`
- `05_results\sionna_cdl_trained_refinement_dev\run_manifest.json`
- `05_results\sionna_cdl_trained_refinement_dev\evaluation_summary.md`
