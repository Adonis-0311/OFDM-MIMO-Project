...
- `min_mean_support_recall`: 0.808594
- `mean_grid_channel_nmse_db_all`: -4.3252
- `mean_source_alpha_channel_nmse_db_all`: -5.70565
- `mean_source_alpha_gain_vs_grid_db`: 1.38045
- `min_source_alpha_gain_vs_grid_db`: 0.924413
- `mean_bounded_refine_channel_nmse_db_all`: -5.70396
- `mean_bounded_gain_vs_grid_db`: 1.37877
- `min_bounded_gain_vs_grid_db`: 0.913456
- `mean_oracle_alpha_channel_nmse_db_all`: -5.89082
- `mean_oracle_alpha_gain_vs_grid_db`: 1.56562
- `mean_source_alpha_gap_vs_oracle_db`: 0.185169
- `mean_oracle_alpha`: 0.7875
- `best_mean_grid_channel_nmse_db`: -6.77874
- `worst_mean_grid_channel_nmse_db`: -2.33737
- `mean_dominant_energy_recall_all`: 0.585577
- `rx_x_span_m`: 24.2
- `rx_y_span_m`: 480.4
- `finite_delay_truth_fraction`: 1
- `finite_power_truth_fraction`: 1
- `elapsed_seconds`: 5.39176
