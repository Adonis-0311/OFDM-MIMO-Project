...
- `min_mean_support_recall`: 0.311875
- `mean_grid_channel_nmse_db_all`: -14.0083
- `mean_source_alpha_channel_nmse_db_all`: -20.8627
- `mean_source_alpha_gain_vs_grid_db`: 6.85443
- `min_source_alpha_gain_vs_grid_db`: -0.197244
- `mean_bounded_refine_channel_nmse_db_all`: -20.4076
- `mean_bounded_gain_vs_grid_db`: 6.39928
- `min_bounded_gain_vs_grid_db`: -0.26066
- `mean_oracle_alpha_channel_nmse_db_all`: -21.8174
- `mean_oracle_alpha_gain_vs_grid_db`: 7.80916
- `mean_source_alpha_gap_vs_oracle_db`: 0.954734
- `mean_oracle_alpha`: 0.784
- `mean_dominant_energy_recall_all`: 0.97068
- `mean_path_count`: 14.25
- `min_path_count`: 8
- `max_path_count`: 21
- `rx_x_span_m`: 9.1026
- `rx_y_span_m`: 8.39998
