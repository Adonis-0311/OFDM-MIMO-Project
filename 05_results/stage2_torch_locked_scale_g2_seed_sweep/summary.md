...
- `epochs`: `6`
- `lr`: 0.08
- `mean_l_cell_gain_vs_grid_db`: 6.17257
- `std_l_cell_gain_vs_grid_db`: 0.90707
- `min_l_cell_gain_vs_grid_db`: 4.47352
- `max_l_cell_gain_vs_grid_db`: 7.42384
- `min_seed_mean_gain_vs_grid_db`: 5.74284
- `mean_train_improvement_db`: 1.1996
- `elapsed_seconds`: 37.1747
...
- `05_results\stage2_torch_locked_scale_g2_seed_sweep\stage2_torch_locked_scale_g2_seed_sweep_seeds.csv`
