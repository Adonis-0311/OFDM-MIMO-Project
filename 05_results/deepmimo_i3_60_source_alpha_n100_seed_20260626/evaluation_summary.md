...
- `min_mean_support_recall`: 0.30875
- `mean_grid_channel_nmse_db_all`: -13.9523
- `mean_source_alpha_channel_nmse_db_all`: -20.3621
- `mean_source_alpha_gain_vs_grid_db`: 6.40972
- `min_source_alpha_gain_vs_grid_db`: -0.18517
- `mean_bounded_refine_channel_nmse_db_all`: -20.0399
- `mean_bounded_gain_vs_grid_db`: 6.08755
- `min_bounded_gain_vs_grid_db`: -0.230577
- `mean_oracle_alpha_channel_nmse_db_all`: -21.4268
- `mean_oracle_alpha_gain_vs_grid_db`: 7.47446
- `mean_source_alpha_gap_vs_oracle_db`: 1.06473
- `mean_oracle_alpha`: 0.7735
- `mean_dominant_energy_recall_all`: 0.970654
- `mean_path_count`: 14.32
- `min_path_count`: 8
- `max_path_count`: 20
- `rx_x_span_m`: 9.1226
- `rx_y_span_m`: 8.27456
