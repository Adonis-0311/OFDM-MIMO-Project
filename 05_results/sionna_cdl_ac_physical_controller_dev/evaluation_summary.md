...
- `mean_trained_refinement_channel_nmse_db`: -16.4375
- `mean_trained_refinement_gain_vs_grid_db`: 6.33394
- `min_cell_trained_refinement_gain_vs_grid_db`: 0.153185
- `mean_grid_physical_delay_rmse_ns`: 353.912
- `mean_trained_refinement_physical_delay_rmse_ns`: 338.887
- `mean_physical_delay_rmse_reduction_vs_grid_ns`: 15.0251
- `mean_grid_projected_broadside_angle_rmse_deg`: 28.1119
- `mean_trained_refinement_projected_broadside_angle_rmse_deg`: 34.0042
- `mean_projected_angle_rmse_reduction_vs_grid_deg`: -5.89226
- `min_cell_physical_delay_rmse_reduction_vs_grid_ns`: -11.3605
- `min_cell_projected_angle_rmse_reduction_vs_grid_deg`: -24.0599
- `delay_resolution_ns`: 130.208
- `elapsed_seconds`: 1.66465
- `claim_update`: `trained-refinement-physical-transfer-mixed`
