...
- `min_mean_support_recall`: 0.8275
- `mean_grid_channel_nmse_db_all`: -4.7182
- `mean_source_alpha_channel_nmse_db_all`: -5.94325
- `mean_source_alpha_gain_vs_grid_db`: 1.22504
- `min_source_alpha_gain_vs_grid_db`: 0.958344
- `mean_bounded_refine_channel_nmse_db_all`: -5.86818
- `mean_bounded_gain_vs_grid_db`: 1.14997
- `min_bounded_gain_vs_grid_db`: 0.952843
- `mean_oracle_alpha_channel_nmse_db_all`: -6.12764
- `mean_oracle_alpha_gain_vs_grid_db`: 1.40943
- `mean_source_alpha_gap_vs_oracle_db`: 0.184389
- `mean_oracle_alpha`: 0.731667
- `best_mean_grid_channel_nmse_db`: -7.46166
- `worst_mean_grid_channel_nmse_db`: -2.49761
- `mean_dominant_energy_recall_all`: 0.617874
- `rx_x_span_m`: 34.4
- `rx_y_span_m`: 546.2
- `finite_delay_truth_fraction`: 1
- `finite_power_truth_fraction`: 1
- `elapsed_seconds`: 14.0752
