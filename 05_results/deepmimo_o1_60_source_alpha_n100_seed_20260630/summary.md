...
- Aggregated rows: `12`
- Sample rows: `1200`
- Minimum mean support recall: `0.8275`
- Mean grid channel NMSE across cells: `-4.7182` dB
- Mean source-alpha channel NMSE across cells: `-5.94325` dB
- Mean source-alpha gain vs grid: `1.22504` dB
- Mean bounded refinement channel NMSE across cells: `-5.86818` dB
- Mean bounded gain vs grid: `1.14997` dB
- Mean source-alpha gap vs oracle-alpha: `0.184389` dB
- Mean dominant energy recall: `0.617874`
- RX x/y span: `34.400` m / `546.200` m
- Elapsed seconds: `14.08`
...
- `05_results\deepmimo_o1_60_source_alpha_n100_seed_20260630\deepmimo_o1_60_g2.csv`
- `05_results\deepmimo_o1_60_source_alpha_n100_seed_20260630\deepmimo_o1_60_g2_samples.csv`
- `05_results\deepmimo_o1_60_source_alpha_n100_seed_20260630\run_manifest.json`
- `05_results\deepmimo_o1_60_source_alpha_n100_seed_20260630\evaluation_summary.md`
