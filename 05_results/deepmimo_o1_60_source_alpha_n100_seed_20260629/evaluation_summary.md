...
- `min_mean_support_recall`: 0.835
- `mean_grid_channel_nmse_db_all`: -4.77395
- `mean_source_alpha_channel_nmse_db_all`: -6.11985
- `mean_source_alpha_gain_vs_grid_db`: 1.3459
- `min_source_alpha_gain_vs_grid_db`: 0.954124
- `mean_bounded_refine_channel_nmse_db_all`: -6.13696
- `mean_bounded_gain_vs_grid_db`: 1.36301
- `min_bounded_gain_vs_grid_db`: 1.0685
- `mean_oracle_alpha_channel_nmse_db_all`: -6.35722
- `mean_oracle_alpha_gain_vs_grid_db`: 1.58327
- `mean_source_alpha_gap_vs_oracle_db`: 0.237373
- `mean_oracle_alpha`: 0.795667
- `best_mean_grid_channel_nmse_db`: -7.55192
- `worst_mean_grid_channel_nmse_db`: -2.5106
- `mean_dominant_energy_recall_all`: 0.624378
- `rx_x_span_m`: 36
- `rx_y_span_m`: 546
- `finite_delay_truth_fraction`: 1
- `finite_power_truth_fraction`: 1
- `elapsed_seconds`: 14.0595
