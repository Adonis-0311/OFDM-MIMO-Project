...
- Mean applied delay/angle alpha: `1.09698` / `0.216017` (`source-trained-feature-controller`)
- Mean channel NMSE gain vs grid: `6.59628` dB
- Mean physical delay RMSE: grid `353.912` ns -> trained `340.203` ns
- Mean projected-angle RMSE: grid `28.1119` deg -> trained `35.553` deg
- Elapsed seconds: `1.78`
...
- `05_results\sionna_cdl_ac_dynamic_controller_dev\sionna_cdl_trained_refinement.csv`
- `05_results\sionna_cdl_ac_dynamic_controller_dev\sionna_cdl_trained_refinement_samples.csv`
- `05_results\sionna_cdl_ac_dynamic_controller_dev\run_manifest.json`
- `05_results\sionna_cdl_ac_dynamic_controller_dev\evaluation_summary.md`
