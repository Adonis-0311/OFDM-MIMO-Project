...
- `delay_alpha`: 0.850259
- `angle_alpha`: 0.110591
- `estimator_mode`: `source-trained-feature-controller`
- `controller_checkpoint`: `05_results\cdl_ac_feature_controller_3seed\controller_checkpoint.pt`
- `controller_ensemble_size`: 3
- `mean_grid_channel_nmse_db`: -10.1036
- `mean_trained_refinement_channel_nmse_db`: -16.2017
- `mean_trained_refinement_gain_vs_grid_db`: 6.09809
- `min_cell_trained_refinement_gain_vs_grid_db`: 0.522198
- `mean_grid_physical_delay_rmse_ns`: 353.912
- `mean_trained_refinement_physical_delay_rmse_ns`: 342.156
- `mean_physical_delay_rmse_reduction_vs_grid_ns`: 11.7559
- `mean_grid_projected_broadside_angle_rmse_deg`: 28.1119
- `mean_trained_refinement_projected_broadside_angle_rmse_deg`: 37.0585
- `mean_projected_angle_rmse_reduction_vs_grid_deg`: -8.94653
- `min_cell_physical_delay_rmse_reduction_vs_grid_ns`: -12.2264
- `min_cell_projected_angle_rmse_reduction_vs_grid_deg`: -29.484
- `delay_resolution_ns`: 130.208
- `elapsed_seconds`: 1.49161
- `claim_update`: `trained-refinement-physical-transfer-mixed`
