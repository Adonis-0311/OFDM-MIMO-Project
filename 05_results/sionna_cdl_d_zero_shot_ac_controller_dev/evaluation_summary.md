...
- `delay_alpha`: 0.745598
- `angle_alpha`: 0.254983
...
- `mean_trained_refinement_channel_nmse_db`: -17.6867
- `mean_trained_refinement_gain_vs_grid_db`: -0.549565
- `min_cell_trained_refinement_gain_vs_grid_db`: -1.6559
- `mean_grid_physical_delay_rmse_ns`: 675.59
- `mean_trained_refinement_physical_delay_rmse_ns`: 681.155
- `mean_physical_delay_rmse_reduction_vs_grid_ns`: -5.56526
- `mean_grid_projected_broadside_angle_rmse_deg`: 33.7992
- `mean_trained_refinement_projected_broadside_angle_rmse_deg`: 40.7332
- `mean_projected_angle_rmse_reduction_vs_grid_deg`: -6.934
- `min_cell_physical_delay_rmse_reduction_vs_grid_ns`: -22.66
- `min_cell_projected_angle_rmse_reduction_vs_grid_deg`: -31.2131
- `delay_resolution_ns`: 130.208
- `elapsed_seconds`: 0.74541
- `claim_update`: `trained-refinement-physical-transfer-refuted`
