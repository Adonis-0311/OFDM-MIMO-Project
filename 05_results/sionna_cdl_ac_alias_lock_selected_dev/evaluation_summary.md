...
- `mean_trained_refinement_channel_nmse_db`: -16.5966
- `mean_trained_refinement_gain_vs_grid_db`: 6.49297
- `min_cell_trained_refinement_gain_vs_grid_db`: 0.534763
- `mean_grid_physical_delay_rmse_ns`: 353.912
- `mean_trained_refinement_physical_delay_rmse_ns`: 340.171
- `mean_physical_delay_rmse_reduction_vs_grid_ns`: 13.7403
- `mean_grid_projected_broadside_angle_rmse_deg`: 28.1119
- `mean_trained_refinement_projected_broadside_angle_rmse_deg`: 27.391
- `mean_projected_angle_rmse_reduction_vs_grid_deg`: 0.720962
- `min_cell_physical_delay_rmse_reduction_vs_grid_ns`: -20.4864
- `min_cell_projected_angle_rmse_reduction_vs_grid_deg`: -1.8829
