...
- `min_mean_support_recall`: 0.316875
- `mean_grid_channel_nmse_db_all`: -14.0422
- `mean_source_alpha_channel_nmse_db_all`: -20.7639
- `mean_source_alpha_gain_vs_grid_db`: 6.72169
- `min_source_alpha_gain_vs_grid_db`: -0.171461
- `mean_bounded_refine_channel_nmse_db_all`: -20.2838
- `mean_bounded_gain_vs_grid_db`: 6.24156
- `min_bounded_gain_vs_grid_db`: -0.224523
- `mean_oracle_alpha_channel_nmse_db_all`: -21.7041
- `mean_oracle_alpha_gain_vs_grid_db`: 7.66187
- `mean_source_alpha_gap_vs_oracle_db`: 0.940182
- `mean_oracle_alpha`: 0.758
- `mean_dominant_energy_recall_all`: 0.97119
- `mean_path_count`: 14.21
- `min_path_count`: 8
- `max_path_count`: 21
- `rx_x_span_m`: 9.1226
- `rx_y_span_m`: 8.39998
