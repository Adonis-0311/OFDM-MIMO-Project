...
- `mean_trained_refinement_channel_nmse_db`: -16.9822
- `mean_trained_refinement_gain_vs_grid_db`: -1.25406
- `min_cell_trained_refinement_gain_vs_grid_db`: -3.31115
- `mean_grid_physical_delay_rmse_ns`: 675.59
- `mean_trained_refinement_physical_delay_rmse_ns`: 685.836
- `mean_physical_delay_rmse_reduction_vs_grid_ns`: -10.2464
- `mean_grid_projected_broadside_angle_rmse_deg`: 33.7992
- `mean_trained_refinement_projected_broadside_angle_rmse_deg`: 33.4205
- `mean_projected_angle_rmse_reduction_vs_grid_deg`: 0.378745
- `min_cell_physical_delay_rmse_reduction_vs_grid_ns`: -37.7445
- `min_cell_projected_angle_rmse_reduction_vs_grid_deg`: -4.55959
- `delay_resolution_ns`: 130.208
- `elapsed_seconds`: 0.875434
- `claim_update`: `trained-refinement-physical-transfer-inconclusive`
