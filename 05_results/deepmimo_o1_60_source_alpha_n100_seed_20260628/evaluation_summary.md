...
- `min_mean_support_recall`: 0.8375
- `mean_grid_channel_nmse_db_all`: -4.58594
- `mean_source_alpha_channel_nmse_db_all`: -5.94767
- `mean_source_alpha_gain_vs_grid_db`: 1.36174
- `min_source_alpha_gain_vs_grid_db`: 0.979072
- `mean_bounded_refine_channel_nmse_db_all`: -5.91496
- `mean_bounded_gain_vs_grid_db`: 1.32903
- `min_bounded_gain_vs_grid_db`: 1.08617
- `mean_oracle_alpha_channel_nmse_db_all`: -6.16943
- `mean_oracle_alpha_gain_vs_grid_db`: 1.5835
- `mean_source_alpha_gap_vs_oracle_db`: 0.22176
- `mean_oracle_alpha`: 0.762333
- `best_mean_grid_channel_nmse_db`: -7.39394
- `worst_mean_grid_channel_nmse_db`: -2.30766
- `mean_dominant_energy_recall_all`: 0.607989
- `rx_x_span_m`: 34.4
- `rx_y_span_m`: 546.2
- `finite_delay_truth_fraction`: 1
- `finite_power_truth_fraction`: 1
- `elapsed_seconds`: 13.8719
