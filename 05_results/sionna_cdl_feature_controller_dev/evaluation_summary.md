...
- `delay_alpha`: 0.685768
- `angle_alpha`: 0.739323
- `estimator_mode`: `source-trained-feature-controller`
- `controller_checkpoint`: `05_results\feature_controller_source_5seed\controller_checkpoint.pt`
- `controller_ensemble_size`: 5
- `mean_grid_channel_nmse_db`: -12.8145
- `mean_trained_refinement_channel_nmse_db`: -16.5395
- `mean_trained_refinement_gain_vs_grid_db`: 3.72503
- `min_cell_trained_refinement_gain_vs_grid_db`: -1.69861
- `mean_grid_physical_delay_rmse_ns`: 461.138
- `mean_trained_refinement_physical_delay_rmse_ns`: 455.283
- `mean_physical_delay_rmse_reduction_vs_grid_ns`: 5.85504
- `mean_grid_projected_broadside_angle_rmse_deg`: 30.0077
- `mean_trained_refinement_projected_broadside_angle_rmse_deg`: 35.7289
- `mean_projected_angle_rmse_reduction_vs_grid_deg`: -5.72123
- `min_cell_physical_delay_rmse_reduction_vs_grid_ns`: -18.9955
- `min_cell_projected_angle_rmse_reduction_vs_grid_deg`: -28.0239
- `delay_resolution_ns`: 130.208
- `elapsed_seconds`: 2.25225
- `claim_update`: `trained-refinement-physical-transfer-mixed`
