...
- `min_mean_support_recall`: 0.836875
- `mean_grid_channel_nmse_db_all`: -4.43145
- `mean_source_alpha_channel_nmse_db_all`: -5.7839
- `mean_source_alpha_gain_vs_grid_db`: 1.35246
- `min_source_alpha_gain_vs_grid_db`: 0.866829
- `mean_bounded_refine_channel_nmse_db_all`: -5.72403
- `mean_bounded_gain_vs_grid_db`: 1.29258
- `min_bounded_gain_vs_grid_db`: 0.92781
- `mean_oracle_alpha_channel_nmse_db_all`: -5.97602
- `mean_oracle_alpha_gain_vs_grid_db`: 1.54458
- `mean_source_alpha_gap_vs_oracle_db`: 0.192121
- `mean_oracle_alpha`: 0.7455
- `best_mean_grid_channel_nmse_db`: -7.09565
- `worst_mean_grid_channel_nmse_db`: -2.27995
- `mean_dominant_energy_recall_all`: 0.597785
- `rx_x_span_m`: 34.4
- `rx_y_span_m`: 547.4
- `finite_delay_truth_fraction`: 1
- `finite_power_truth_fraction`: 1
- `elapsed_seconds`: 16.6658
