...
- Mean L-cell gain over grid Tensor-OMP: 5.8956 dB
- Std. L-cell gain over grid Tensor-OMP: 0.3595 dB
- Minimum L-cell gain over grid Tensor-OMP: 5.3863 dB
- Minimum per-seed mean gain: 5.8113 dB
- Seed-mean gain 95% CI: [5.7830, 6.0083] dB
- Mean train NMSE improvement: 1.1871 dB
- Wall-clock elapsed time: 229.73 s
